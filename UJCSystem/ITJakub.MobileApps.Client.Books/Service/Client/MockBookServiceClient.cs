...
{
    public class MockBookServiceClient : IBookServiceClient
    {
        ...
        public Task<IList<PageContract>> GetPageListAsync(string bookGuid)
        {
            return Task.Run(async () =>
            {
                ...
                {
                    new PageContract {Name = "1L", XmlId = "1"},
                    new PageContract {Name = "1R", XmlId = "2"},
                    new PageContract {Name = "2L", XmlId = "3"},
                    new PageContract {Name = "2R", XmlId = "4"},
                    new PageContract {Name = "3L", XmlId = "5"},
                    new PageContract {Name = "3R", XmlId = "6"},
                    new PageContract {Name = "4L", XmlId = "7"},
                    new PageContract {Name = "4R", XmlId = "8"},
                    new PageContract {Name = "5L", XmlId = "9"},
                    new PageContract {Name = "5R", XmlId = "10"},
                    new PageContract {Name = "6L", XmlId = "11"},
                    new PageContract {Name = "6R", XmlId = "12"},
                    new PageContract {Name = "7L", XmlId = "13"},
                    new PageContract {Name = "7R", XmlId = "14"},
                    new PageContract {Name = "8L", XmlId = "15"},
                    new PageContract {Name = "8R", XmlId = "16"},
                    new PageContract {Name = "9L", XmlId = "17"},
                    new PageContract {Name = "9R", XmlId = "18"},
                    new PageContract {Name = "10L", XmlId = "19"},
                    new PageContract {Name = "10R", XmlId = "20"},
                    new PageContract {Name = "11L", XmlId = "21"},
                    new PageContract {Name = "12R", XmlId = "22"}
                };
                return list;
            });
        }
