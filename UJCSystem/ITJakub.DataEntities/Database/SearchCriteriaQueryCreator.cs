...
namespace ITJakub.DataEntities.Database
{
    public class SearchCriteriaQueryCreator
    {
        ...
        {
            var selectQueryString =
                "select distinct b1.Guid as BookGuid, bv1.Title as BookTitle, bv1.Acronym as BookAcronym, bh1.DefaultHeadword as Headword, bh1.XmlEntryId as XmlEntryId, bh1.SortOrder as SortOrder from Book b1 inner join b1.LastVersion bv1 inner join bv1.BookHeadwords bh1";
