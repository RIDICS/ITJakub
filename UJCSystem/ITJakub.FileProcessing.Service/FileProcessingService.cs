...
namespace ITJakub.FileProcessing.Service
{
    public class FileProcessingService : IFileProcessingService
    {
        ...
        public ImportResultContract ProcessSession(string sessionId, long? projectId, int userId, string uploadMessage, ProjectTypeContract projectType, IList<PermissionFromAuthContract> autoImportPermissions)
        {
            return m_sessionManager.ProcessSession(sessionId, projectId, userId, uploadMessage, projectType, autoImportPermissions);
        }
    }
}