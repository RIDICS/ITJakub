...
using ITJakub.MobileApps.Client.Fillwords2.ViewModel.Comparer;
...
namespace ITJakub.MobileApps.Client.Fillwords2.ViewModel
{
    public class FillwordsAdminViewModel : AdminBaseViewModel
    {
        ...
        public override void SetTask(string data)
        {
            ...
            {
                var newOptionsList = new ObservableCollection<SimpleWordOptionsViewModel>();
                foreach (var optionsViewModel in task.Options)
                {
                    var newOptionsViewModel = new SimpleWordOptionsViewModel
                    {
        ...
        private void ShowAnswersForUser(UserResultViewModel currentUserResult)
        {
            ...
            for (int i = 0; i < TaskOptionsList.Count; i++)
            {
                ...
                optionsViewModel.SelectedAnswer = resultUserAnswer.Answer;
                optionsViewModel.AnswerState = resultUserAnswer.AnswerState;
            }
        }
        ...
        private void ShowUnknownAnswers()
        {
            ...
            {
                optionsViewModel.SelectedAnswer = "???";
