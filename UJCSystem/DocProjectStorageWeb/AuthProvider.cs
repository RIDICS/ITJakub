...
{
    public class AuthProvider : ExtendedMembershipProvider
    {
        ...
        //Application name
        private string applicationName = "DocumentStorage";
        ...
        DocProjectStorageWeb.AccountsServiceReference.IAccountsService authService = new DocProjectStorageWeb.AccountsServiceReference.AccountsServiceClient();
        ...
        {
            return authService.GetUserNameByEmail(email);
        }
