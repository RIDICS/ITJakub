...
abstract class ReaderLayout {
    ...
    createViewPanel(buttonId: string, innerHtml: string) { throw new Error("Not implemented"); }
    createToolPanel(buttonId: string, innerHtml: string) { throw new Error("Not implemented"); }
