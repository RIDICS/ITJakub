...
namespace ITJakub.Web.Hub.Areas.Tools.Controllers
{
    ...
    public class ToolsController : BaseController
    {
        ...
        public ToolsController(StaticTextManager staticTextManager, FeedbacksManager feedbacksManager, CommunicationProvider communicationProvider, HttpErrorCodeTranslator httpErrorCodeTranslator) : base(
