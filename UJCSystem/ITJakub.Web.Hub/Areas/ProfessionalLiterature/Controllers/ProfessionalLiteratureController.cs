...
namespace ITJakub.Web.Hub.Areas.ProfessionalLiterature.Controllers
{
    ...
    public class ProfessionalLiteratureController : AreaController
    {
        ...
        public ProfessionalLiteratureController(StaticTextManager staticTextManager, FeedbacksManager feedbacksManager, CommunicationProvider communicationProvider, 
