...
{
    public class ReaderRichEditBox : BindableRichEditBox
    {
        ...
        public static readonly DependencyProperty SelectionStartProperty = DependencyProperty.Register("SelectionStart", typeof(int), typeof(ReaderRichEditBox), new PropertyMetadata(default(int), OnSelectionPropertyChanged));

        public static readonly DependencyProperty SelectionLengthProperty = DependencyProperty.Register("SelectionLength", typeof(int), typeof(ReaderRichEditBox), new PropertyMetadata(default(int), OnSelectionPropertyChanged));
        ...
        {
            var richEditBox = d as ReaderRichEditBox;
            if (richEditBox == null)
                return;

            if (richEditBox.m_selectionChangedRespond)
                richEditBox.Document.Selection.SetRange(richEditBox.SelectionStart, richEditBox.SelectionStart + richEditBox.SelectionLength);
        }
        ...
        private void OnSelectionChanged(object sender, RoutedEventArgs e)
        {
            ...
            SelectionLength = Document.Selection.EndPosition - Document.Selection.StartPosition;
            m_selectionChangedRespond = true;
        }
    }
}
