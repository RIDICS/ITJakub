...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template match="/">
        <xsl:comment> Dodavky_Header </xsl:comment>
    ...
    <xsl:template name="insert-header">
        <teiHeader xmlns="http://www.tei-c.org/ns/1.0" xml:id="Dodavky" n="Dodavky">
            <fileDesc n="{{EF70B87F-E8F0-440A-9713-9D2C0DF241E7}}">
                <titleStmt>
                ...
                <editionStmt>
                    ...
                    <respStmt><resp>editor</resp><name>Černá, Alena M.</name></respStmt>
                    <respStmt><resp>editor</resp><name>Oliva, Karel</name></respStmt>
                    <respStmt><resp>editor</resp><name>Lehečka, Boris</name></respStmt>
                    <respStmt><resp>editor</resp><name>Honková, Tereza</name></respStmt>
                    <respStmt><resp>editor</resp><name>Ulmanová, Kateřina</name></respStmt>
                ...
                <sourceDesc n="bibl">
                    <p><bibl type="source"><author><forename>František Ladislav</forename> <surname>Čelakovský</surname></author>. <title>Dodavky ke slovníku Josefa Jungmanna</title>. <pubPlace>Praha</pubPlace> <date>1851</date>.</bibl></p>
                </sourceDesc>
                <sourceDesc>
                    <msDesc xml:lang="cs">
                        <msIdentifier>
                        ...
                        <msContents>
                            <msItem>
                                <title>Dodavky ke slovníku Josefa Jungmanna</title>
                                <author><forename>František Ladislav</forename> <surname>Čelakovský</surname></author>
                            </msItem>
                        </msContents>
                        <history>
                            <origin>
