...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template match="/">
        ...
        <xsl:comment> Vokab1550_Hlavicka </xsl:comment>
        <xsl:text xml:space="preserve">
</xsl:text>
    ...
    <xsl:template name="insert-header">
        <teiHeader xmlns="http://www.tei-c.org/ns/1.0" xml:id="Vokab1550" n="Vokab1550">
            <fileDesc n="{{CCA0346E-4C43-4BEA-9066-32F5BB98637A}}">
                <titleStmt>
