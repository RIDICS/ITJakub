...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template match="/">
        ...
        <xsl:comment> SlovKNM_Hlavicka </xsl:comment>
        <xsl:text xml:space="preserve">
</xsl:text>
    ...
    <xsl:template name="insert-header">
        <teiHeader xmlns="http://www.tei-c.org/ns/1.0" xml:id="SlovNMK" n="SlovNMK">
            <fileDesc n="{{19E06AFF-2B96-4704-BAE8-595A98096E33}}">
                <titleStmt>
                    <title>Velmi užitečná kníška mládencóm</title>
                </titleStmt>
                <editionStmt>
