...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	extension-element-prefixes="vwf fn" exclude-result-prefixes="xd vwf xs" version="2.0">
	...
	<xsl:template match="tei:unclear[preceding-sibling::node()[not(self::text()[normalize-space()=''])][1][self::*]]" priority="5">

		<xsl:call-template name="process-unclear">
			<xsl:with-param name="current-text">
				<xsl:copy-of select="tei:supplied/text()" />
			</xsl:with-param>
	...
	<xsl:template match="tei:unclear[following-sibling::node()[not(self::text()[normalize-space()=''])][1][self::*]]" priority="3">
	...
	<xsl:template match="tei:unclear[following-sibling::node()[not(self::text()[normalize-space()=''])]]">
	...
	<xsl:template match="tei:unclear   [preceding-sibling::*[1]/self::tei:supplied]   [following-sibling::*[1][self::text][not(contains(text()[1], ' '))]   and following-sibling::*[1]/child::*[1]/self::tei:unclear   ]" priority="20">
	...
	<xsl:template match="tei:unclear[preceding-sibling::node()[not(self::text()[normalize-space()=''])][1][self::*]    and following-sibling::node()[not(self::text()[normalize-space()=''])][1][self::*]]" priority="10">
	...
	<xsl:template match="tei:unclear[preceding-sibling::node()[1][not(self::text()[normalize-space()=''])[1]]]" priority="5">
		<xsl:call-template name="process-unclear">
			...
			<xsl:with-param name="current-text">
				...
				<!--	<xsl:when test="parent::*[1]/preceding-sibling::node()[1]/self::unclear 
					...
					<xsl:when test="contains(normalize-space(tei:supplied), $mezera)">
						<xsl:value-of select="tei:supplied/text()" />
					</xsl:when>
					<xsl:when test="preceding-sibling::node()[1]/self::text() and contains(preceding-sibling::node()[1], $mezera)">
						<xsl:copy-of select="tei:supplied/text()" />
					</xsl:when>
					<xsl:when test="parent::*[1]/preceding-sibling::node()[1]/self::tei:unclear and not(contains(parent::*[1]/preceding-sibling::*[1]/self::tei:unclear, $mezera))">
						<xsl:value-of select="''" />
					</xsl:when>
					<xsl:otherwise>
						<xsl:copy-of select="tei:supplied/text()" />
			...
			<xsl:with-param name="source-previous-text">
				<xsl:choose>
					<xsl:when test="preceding-sibling::node()[2]/self::tei:unclear 
						and not(contains(preceding-sibling::node()[2], $mezera)) 
						and not(contains(preceding-sibling::node()[1], $mezera))">
						<xsl:value-of select="''" />
					</xsl:when>
					
					<xsl:when test="parent::*[1]/preceding-sibling::node()[1]/self::tei:unclear 
						and not(contains(preceding-sibling::node()[1], $mezera)) 
					...
					<xsl:when test="parent::*[1]/preceding-sibling::node()[1]/self::tei:unclear 
						and not(contains(parent::*[1]/preceding-sibling::*[1]/self::tei:unclear, $mezera))">
						<xsl:value-of select="''" />
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="''" />
			...
			<xsl:with-param name="previous-node">
				<xsl:if test="preceding-sibling::node()[1]/self::tei:unclear">
					<xsl:value-of select="preceding-sibling::node()[1]" />
				</xsl:if>
			</xsl:with-param>
			
			<xsl:with-param name="source-next-next-node">
				<xsl:if test="following-sibling::node()[2]/self::tei:unclear">
					<xsl:value-of  select="following-sibling::node()[2]" />
				</xsl:if>
			</xsl:with-param>
	...
	<xsl:template match="text()[1][not(self::text()[normalize-space()=''])[1]][following-sibling::node()[1]/self::tei:unclear]   [parent::*[1]/preceding-sibling::*[1][self::tei:unclear]]" priority="5">

		<xsl:call-template name="process-text-node">
			<xsl:with-param name="current-text" select="." />
			<xsl:with-param name="next-unclear">
				<xsl:copy-of select="following-sibling::node()[1]/self::tei:unclear/tei:supplied/text()" />
			</xsl:with-param>
			<xsl:with-param name="previous-unclear">
				<xsl:value-of select="parent::*[1]/preceding-sibling::*[1]/self::tei:unclear/tei:supplied/text()" />
			</xsl:with-param>
		</xsl:call-template>
	...
	<xsl:template match="text()[not(self::text()[normalize-space()=''])[1]][following-sibling::node()[1]/self::tei:unclear]">
		...
		<xsl:call-template name="process-text-node">
			...
			<xsl:with-param name="previous-unclear">
				<xsl:value-of select="preceding-sibling::node()[1]/self::tei:unclear/tei:supplied/text()" />
			</xsl:with-param>
		</xsl:call-template>
	...
	<xsl:template match="text()[not(self::text()[normalize-space()=''])[1]][preceding-sibling::node()[1]/self::tei:unclear]">

		<xsl:call-template name="process-text-node">
			<xsl:with-param name="current-text" select="." />
			<xsl:with-param name="next-unclear">
				<xsl:value-of select="following-sibling::node()[1]/self::tei:unclear/tei:supplied/text()" />
			</xsl:with-param>
			<xsl:with-param name="previous-unclear">
				<xsl:value-of select="preceding-sibling::node()[1]/self::tei:unclear/tei:supplied/text()" />
			</xsl:with-param>
	...
	<xsl:template match="text()[not(self::text()[normalize-space()=''])[1]][preceding-sibling::node()[1]/self::tei:unclear][following-sibling::node()[1]/self::unclear]" priority="5">
	...
	<xsl:template match="text()[1][not(self::text()[normalize-space()=''])[1]][parent::*[1]/preceding-sibling::*[1][self::tei:unclear]]">
		<xsl:call-template name="process-text-node">
			<xsl:with-param name="current-text" select="." />
			<xsl:with-param name="next-unclear">
	...
	<xsl:template match="tei:corr | tei:sic | tei:note">
		<xsl:copy-of select="." />
	</xsl:template>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:copy>
					<xsl:copy-of select="@*" />
					<xsl:value-of select="$result-previous-text" />
					<xsl:copy-of select="tei:supplied" />
					<xsl:value-of select="$result-next-text" />
					<xsl:if test="$result-next-text != '' and $next-text-delimiter = $mezera">
						<xsl:value-of select="$mezera" />
					</xsl:if>
