...
namespace Vokabular.MainService.Core.Managers.Fulltext
{
    public interface IFulltextStorage
    {
        ...
        FulltextSearchResultData SearchProjectIdByCriteria(SearchRequestContract searchRequestContract, List<SearchCriteriaContract> criteria, IList<ProjectIdentificationResult> projects);
