...
BEGIN TRAN
	...
	(
		...
		NULL -- CanReadExternalProject - bit
	)
	...
	(
	    -- Id - int
	    'ReadExternalProject', -- PermissionType - varchar
		0, -- PermissionCategorization - tinyint
	    NULL, -- CanUploadBook - bit
	    NULL, -- CanManagePermissions - bit
	    NULL, -- CanAddNews - bit
		...
		NULL, -- CanEditionPrintText - bit
		NULL, -- CanEditStaticText - bit
		NULL, -- CanManageRepositoryImport - bit
		1 -- CanReadExternalProject - bit
	)
	...
	SELECT sp.Id, @AdminGroupId FROM dbo.SpecialPermission sp WHERE sp.PermissionType = 'ReadExternalProject'
