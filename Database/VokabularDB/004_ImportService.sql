...
BEGIN TRAN
	...
	(
		...
		[LastSuccessfulUpdate] int NULL CONSTRAINT [FK_ImportMetadata(LastSuccessfulUpdate)_ImportHistory(Id)] FOREIGN KEY REFERENCES [dbo].[ImportHistory] (Id),
		[Snapshot] bigint NOT NULL CONSTRAINT [FK_ImportMetadatay(Project)_Snapshot(Id)] FOREIGN KEY REFERENCES [dbo].[Snapshot] (Id),
	)
