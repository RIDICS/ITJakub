  ...
  <xsl:strip-space elements="*"/>
	...
	<xd:doc scope="stylesheet">
		<xd:desc>
			...
			<xd:p>Přesune element kniha a kapitola (členění bible) před značku odstavce, nadpisu atp., pokud jde o první značku</xd:p>
		</xd:desc>
	</xd:doc>
...
<!--	<xsl:template match="body" priority="2">
	...
	<xsl:template match="/doc//*[name(child::*[position() = 1]) = 'kniha']">
