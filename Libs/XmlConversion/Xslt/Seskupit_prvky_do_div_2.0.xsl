		...
		<xsl:copy>
			<xsl:choose>
				<!--<xsl:when test="*[@type='editorial' and @subtype='comment']">
					<xsl:for-each-group group-starting-with="*[@type='editorial' and @subtype='comment']" select="*">
						<xsl:apply-templates select="." mode="group" />
					</xsl:for-each-group>					
				</xsl:when>
				<xsl:when test="*[@type='editorial' and @subtype='grant']">
					<xsl:for-each-group group-starting-with="*[@type='editorial' and @subtype='grant']" select="*">
						<xsl:apply-templates select="." mode="group" />
					</xsl:for-each-group>					
				</xsl:when>-->
				<xsl:when test="thead[@type='editorial' and @subtype='comment']">
					<xsl:for-each-group group-starting-with="thead[@type='editorial' and @subtype='comment']" select="*">
						<xsl:apply-templates select="." mode="group" />
					</xsl:for-each-group>					
				</xsl:when>
